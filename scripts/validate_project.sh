...
"$PYTHON_BIN" -m pytest -q \
  ...
  tests/test_direct_loan_cdas_metadata.py \
  ...
  tests/test_collection_charge_policy.py \
  tests/test_signed_contract_intake.py \
  tests/test_backdated_opening_adjustments.py \
