...
from routers import (
    ...
    cdas_audit_trail,
    cdas_booking,
    cdas_booking_calendar,
    cdas_booking_failures,
    cdas_bulk_processing,
    cdas_change_detection,
    cdas_contact_followups,
    cdas_daily_intelligence,
    cdas_data_quality,
    cdas_duplicate_detection,
    cdas_employee_verification,
    cdas_intelligence,
    cdas_lifecycle,
    cdas_management_dashboard,
    cdas_monthly_automation,
    cdas_officer_performance,
    cdas_opportunity_pipeline,
    chat,
...
_ROUTE_REGISTRY = (
    ...
    cdas_api.router,
    cdas_employee_verification.router,
    cdas_intelligence.router,
    cdas_lifecycle.router,
    cdas_daily_intelligence.router,
    cdas_monthly_automation.router,
    cdas_booking.router,
    cdas_booking_calendar.router,
    cdas_bulk_processing.router,
    cdas_advanced_search.router,
    cdas_application_handoff.router,
    cdas_audit_trail.router,
    cdas_management_dashboard.router,
    cdas_opportunity_pipeline.router,
    cdas_contact_followups.router,
    cdas_booking_failures.router,
    cdas_change_detection.router,
    cdas_data_quality.router,
    cdas_duplicate_detection.router,
    cdas_officer_performance.router,
